...
/** @var list<array<string, mixed>> $recentReturns */
?>
...
<div class="card">
  ...
  <?php foreach ($loans as $loan): ?>
    <?php $overdue = ($loan['status'] ?? '') === 'overdue'; ?>
...
<div class="card">
  <h2 class="section-title" style="margin-top:0">최근 반납</h2>
  ...
  <?php endforeach; ?>
  <?php if (!$recentReturns): ?><p class="muted">최근 반납 이력이 없습니다.</p><?php endif; ?>
</div>
