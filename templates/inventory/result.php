...
<div class="actions">
  ...
  <a class="btn btn-ghost" href="<?= Support::e(App::url('inventory/report', ['check_id' => $check['id']])) ?>">사업예산별 리포트</a>
  <a class="btn btn-ghost" href="<?= Support::e(App::url('inventory/report/csv', ['check_id' => $check['id']])) ?>">차이 CSV</a>
