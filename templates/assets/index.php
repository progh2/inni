...
?>
<h1>기자재 현황</h1>
<p class="muted">검색 없이 전체 장비를 훑습니다. 상태·실·연체·사업예산으로 거를 수 있습니다. 내용연한(쓸 수 있는 햇수)이 임박(1년 안)이거나 초과(이미 지남)인 장비는 <a href="<?= Support::e(App::url('assets/aging')) ?>">연한·노후 기자재</a>에서 봅니다.</p>
