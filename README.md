...
- 소모품·부품 상세: 위치별 **분출**(수량·실·사유·선택 수업 메모), 이력 실 필터
- 라벨 인쇄 (브라우저 QR + 인쇄)  
