...
- 홈 / 찾기 / **스캔**(카메라 QR) / 실별 목록 / **품목 목록**(검색 없이 브라우즈, 유형·재고부족·사업예산 필터) / 기자재 현황(상태·실·연체·사업예산 필터, 검색 불필요) / 빠른 등록  
