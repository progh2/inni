...
- 품목 CSV (담당교사·관리자): 템플릿/목록 내려받기, 업로드로 신규·수정. **CSV UTF-8만** (xlsx 없음). 충돌 행은 건너뛰고 보고. 에듀파인 파일 동기화·실사 연동 없음. 사업명·예산연도 열 포함  
